...
├── /sitemap.xml                   — machine index (38 URLs, generated by tools/build-sitemap.mjs)
├── /llms.txt                      — LLM discovery index (generated by tools/build-llms-txt.mjs)
├── /llms-full.txt                 — full single-fetch content index for answer engines
├── /robots.txt                    — search + AI/LLM crawler allow-list
│
├── /Sub_Pages/
